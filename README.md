...
---JWT are stateless and sessions are stateful 
...
---unit test test different parts of the application in small pieces, E2E testing test the workflow from beginning to end
